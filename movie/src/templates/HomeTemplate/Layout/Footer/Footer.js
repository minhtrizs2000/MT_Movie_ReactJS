                ...
                <div className="grid grid-cols-12">
                    ...
                    <div className="col-span-6 text-center md:text-left md:col-span-3">
                        ...
                        <div className="flex justify-left pt-4 space-x-4 lg:pt-0 lg:col-end-13">
                            ...
                            <a href="#" className="flex items-center justify-center w-8 h-8 rounded-full sm:w-10 sm:h-10 dark:bg-violet-400 dark:text-coolGray-900">
                        ...
                        <div className="mt-4 flex justify-left pt-4 space-x-4 lg:pt-0 lg:col-end-13">
                            <a href="#" className="flex items-center justify-center w-8 h-8 rounded-full sm:w-10 sm:h-10 dark:bg-violet-400 dark:text-coolGray-900">
