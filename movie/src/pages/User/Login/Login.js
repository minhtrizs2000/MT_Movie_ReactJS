                ...
                <div className="mt-12">
                    <form onSubmit={handleSubmit}>
                        <div>
                            ...
                            <input name="taiKhoan" onChange={handleChange} className="w-full text-lg py-2 border-b border-gray-300 focus:outline-none focus:border-indigo-500" placeholder="Enter your username" onBlur={handleBlur} />
                        ...
                        <div className="mt-8">
                            <div className="flex justify-between items-center">
                                ...
                                <div>
                                    <div onClick={() => {
                                        alert('Tính năng đang phát triển thêm! :3')
                            ...
                            <input name="matKhau" onChange={handleChange} className="w-full text-lg py-2 border-b border-gray-300 focus:outline-none focus:border-indigo-500" type="password" placeholder="Enter your password" onBlur={handleBlur} />
                    ...
                    {t("Don't have an account")} ? <NavLink to="/register" className="cursor-pointer text-indigo-600 hover:text-indigo-800">{t('Register')}</NavLink>
                    </div>
                </div>
            </div>
        </div>
