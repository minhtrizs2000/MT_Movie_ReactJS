...
export default function Register(props) {
    ...
    return (
        <div className="lg:w-1/2 xl:max-w-screen-sm">
            <div className="pt-4 bg-indigo-100 lg:bg-white flex justify-center lg:justify-start lg:px-12">
                <div onClick={()=>history.push('/')} className="cursor-pointer flex items-center">
                    <div>
                ...
                <div className="mt-12">
                    <form onSubmit={handleSubmit}>
                        <div className="py-2">
                            ...
                            <input name="taiKhoan" onChange={handleChange} onBlur={handleBlur} className="w-full text-lg py-2 border-b border-gray-300 focus:outline-none focus:border-indigo-500" placeholder="Enter your username" />
                            {touched.taiKhoan && errors.taiKhoan && <p className="text-lg text-red-500">{formik.errors.taiKhoan}</p>}
                        </div>
                        <div className="py-2">
                            <div className="text-sm font-bold text-gray-700 tracking-wide">{t('Password')}</div>
                            <input name="matKhau" onChange={handleChange} onBlur={handleBlur} className="w-full text-lg py-2 border-b border-gray-300 focus:outline-none focus:border-indigo-500" placeholder="Enter your password" />
                        ...
                        <div className="py-2">
                            ...
                            <input name="hoTen" onChange={handleChange} onBlur={handleBlur} className="w-full text-lg py-2 border-b border-gray-300 focus:outline-none focus:border-indigo-500" placeholder="Enter your fullname" />
                        ...
                        <div className="py-2">
                            ...
                            <input name="email" onChange={handleChange} onBlur={handleBlur} className="w-full text-lg py-2 border-b border-gray-300 focus:outline-none focus:border-indigo-500" placeholder="Enter your email" />
                            {touched.email && errors.email && <p className="text-lg text-red-500">{formik.errors.email}</p>}
                        </div>
                        <div className="py-2">
                            <div className="text-sm font-bold text-gray-700 tracking-wide">{t('Phone Number')}</div>
                            <input name="soDt" onChange={handleChange} onBlur={handleBlur} className="w-full text-lg py-2 border-b border-gray-300 focus:outline-none focus:border-indigo-500" placeholder="Enter your phone number" />
                    ...
                    {t('Already have an account')} ? <NavLink to="/login" className="cursor-pointer text-indigo-600 hover:text-indigo-800">{t('Login')}</NavLink>
                    </div>
                </div>
            </div>
        </div>
